...
- **🛜 Network & Proxy Hub:** Atur Box For Root, Tailscale VPN, konfigurasi TTL, IP Hunter, dan antarmuka nirkabel (Wireless/SIM) dengan mudah.
- **📱 Device Controller:** Fitur bawaan seperti SCRCPY (Cermin Layar), SMS Viewer, APK Manager, dan Terminal emulator yang berjalan mulus di browser.
- **🔄 OTA (Over-The-Air) Updates:** Perbarui AWD OS dengan sekali klik langsung dari Dashboard tanpa perlu mem-flash modul secara manual lagi!

## 📦 Repositori Rilis
Repositori ini HANYA digunakan sebagai **hosting rilis OTA** (Over-The-Air). 
File yang ada di sini adalah paket modul Magisk yang sudah jadi (dikompilasi) dan siap pasang.
